...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/products/admin/store/', 'ProductController@store')->name('admin_products.store');
    ...
    Route::get('/subscription_history/{user_id?}', 'SellerController@subscription_history')->name('sellers.subscription_history');
    ...
    Route::post('/file_system_update', 'BusinessSettingsController@file_system_update')->name('file_system.update');
    ...
    Route::post('/ship_engine', 'BusinessSettingsController@ship_engine_update')->name('ship_engine.update');
    ...
    // Manage owe amount
    Route::get('/manage_owe_amount', 'OweAmountController@index')->name('manage_owe_amount');
    Route::get('/merchant_orders/{id}/show', 'OweAmountController@show')->name('merchant_orders.show');
    ...
    // Manage Subscription Plan Start

    Route::get('subscription_plan', 'SubscriptionPlansController@index')->name('subscription.index');
    Route::post('user_custom_subscription', 'SubscriptionPlansController@user_custom_subscription')->name('user_custom_subscription');
    Route::match(array('GET', 'POST'),'/add_subscription', 'SubscriptionPlansController@add')->name('subscription.add');
    Route::match(array('GET', 'POST'),'/edit_subscription/{id}', 'SubscriptionPlansController@edit')->name('subscription.edit');
    Route::get('/delete_subscription/{id}', 'SubscriptionPlansController@delete')->name('subscription.delete');
    
    // Manage Subscription Plaan End
    ...
    Route::get('/shipping_configuration/carriers', 'ShipEngineController@ship_engine_carriers')->name('shipping_configuration.carriers');
    ...
    Route::match(['GET', 'POST'], 'deleted_user_reports', 'ReportController@deleted_user_index')->name('deleted_user_reports');

    // ship engine routes seller based
    Route::post('/connect_carriers', 'ShipEngineController@connect_carriers')->name('connect_carriers');
    Route::post('/disconnect_carriers', 'ShipEngineController@disconnect_carriers')->name('disconnect_carriers');
});
