...
Route::group(['prefix'=>'v2/auth','middleware'=>['api']], function () {
    ...
    Route::match(array('GET', 'POST'),'apple_login', 'Api\V2\AuthController@appleLogin');
    Route::match(array('GET', 'POST'),'apple_callback', 'Api\V2\AuthController@appleCallback');
...
Route::group(['prefix'=>'v2','middleware'=>['api']],function () {
    ...
    Route::get('common_data', 'Api\V2\HomeCategoryController@common_data');
    Route::get('pickup_points', 'Api\V2\PickuppointController@pickup_point');
    Route::post('pickup_points_store', 'Api\V2\PickuppointController@pickup_points_store')->middleware('auth:api');
    ...
    Route::get('chat/get-new-messages', 'Api\V2\ChatController@get_new_messages')->middleware('auth:api');
    ...
    Route::get('purchase-history/{id}', 'Api\V2\PurchaseHistoryController@index')->name('purchaseHistory.details');
    ...
    Route::get('cart-summary/{user_id}/{owner_id}', 'Api\V2\CartController@summary');
    ...
    Route::post('delivery_info/{user_id}', 'Api\V2\ShipEngineController@delivery_info');
    Route::post('cart/updateRateId', 'Api\V2\ShipEngineController@updateRateId');
    Route::post('cart/updateQuantity', 'Api\V2\ShipEngineController@updateQuantity');
    ...
    Route::post('ship_estimate', 'ShipEngineController@show_all_prices');
    ...
    Route::get('countries_data', 'Api\V2\AddressController@getCountriesData');
    ...
    Route::post('payments/pay/full_discount', 'Api\V2\PaymentController@fullDiscount');
    ...
    Route::post('profile/delete_account_otp', 'Api\V2\ProfileController@delete_account_otp')->middleware('auth:api');
    Route::post('profile/delete_account', 'Api\V2\ProfileController@delete_account')->middleware('auth:api');
    ...
    Route::get('language','Api\V2\UserController@language');    
});
