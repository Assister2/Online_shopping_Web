                    ...
                    <div class="card-body">
                        ...
                        <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') || canDisplayCredentials() ? 'admin@gmail.com' : '' }}" required autofocus placeholder="{{ translate('Email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ canDisplayCredentials() ? '123456' : '' }}" required placeholder="{{ translate('Password') }}">
