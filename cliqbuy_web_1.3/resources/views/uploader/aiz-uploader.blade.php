...
<div class="modal fade" id="aizUploaderDelete" data-backdrop="static" role="dialog" aria-hidden="true" >
	<div class="modal-dialog modal-adaptive" role="document">
		<div class="modal-content ">
			...
			<div class="modal-body">
				<p>{{ translate("sure_delete") }}</p>
			</div>
			<div class="modal-footer justify-content-end bg-light">
				
				<button type="button" class="btn btn-sm btn-primary aiz-uploader-confirmed-delete ">{{ translate("confirm_delete") }}</button>
			</div>
		</div>
	</div>
</div>