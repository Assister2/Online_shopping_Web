<div class="card border-0 shadow-sm rounded">
    <div class="card-header">
        ...
        <div class="text-right">
            <span class="badge badge-inline badge-primary badge_lght_orange">
                {{ count($carts) }} 
                {{translate('Items')}}
            </span>
        </div>
    ...
    <div class="card-body border-top-0">
        ...
        <table class="table mb-0">
            <thead>
                <tr>
                    <th class="product-name border-bottom-0">{{translate('Product')}}</th>
                    <th class="product-total border-bottom-0 text-right">{{translate('Total')}}</th>
                </tr>
            </thead>
            <tbody>
                @php
        ...
        <table class="table">
            ...
            <tfoot>
                ...
                <tr class="cart-total  text-primary">
