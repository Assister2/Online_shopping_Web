                ...
                <div class="row">
                    <div class="col">
                        <div class="aiz-carousel gutters-10" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay='true' data-infinute="true" data-dots="true">
                            @if($shop->user->products->count() > 0)
                                @foreach ($shop->user->products->where('published', 1)->where('approved', 1)->where('featured', 1) as $key => $product)
                                    <div class="carousel-box">
                                        @include('frontend.partials.product_box_1',['product' => $product])
                                    </div>
                                @endforeach
                            @else
                                <span class="fw-300 h3 pb-3 d-inline-block align-items-center">
