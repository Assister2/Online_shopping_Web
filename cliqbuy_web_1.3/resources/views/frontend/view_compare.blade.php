                                ...
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td class="text-center">
                                          <span class="d-inline-block" style="height:200px;width:200px">
                                          <img loading="lazy" src="{{ uploaded_asset(\App\Product::find($item)->thumbnail_img) }}" alt="{{ translate('Product Image') }}" class="w-100 h-100 py-4" style="object-fit:cover">
                                          </span>
                                        </td>
                                    @endforeach
                                </tr>
