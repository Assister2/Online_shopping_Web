...
<div class="cls_bread">
    <ul>
        ...
        <li><a>{{ translate('Add Your Product')}}</a></li>
    </ul>
</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <small class="text-muted">{{translate('Only 15 characters of tag is entered')}}</small><br>
...
<!--                    <div class="form-group row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="radio" name="shipping_type" class="parent_provider" value="free" checked>
                                <span></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="radio" name="shipping_type" class="parent_provider" value="flat_rate">
                                <span></span>
                            </label>
                        </div>
                    </div>
                    ...
                    @if($ship_engine_found)
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" class="parent_provider" name="shipping_type" value="shipping_providers">
                                    <span></span>
                                </label>
                            </div>
                        </div>
        ...
        <div class="col-12">
            <div class="mar-all text-right">
                <button type="{{$enable_add_product=='true'?'submit':'button'}}" name="button" value="publish"
                    class="btn btn-primary {{$enable_add_product=='true'?'':'disabled'}} form-button" id="choice_form_submit">{{ translate('Upload Product') }}</button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (){
         ...
         $('#choice_form').on('submit', function(e){
            ...
            $("#choice_form_submit").attr("disabled", true);
            $('#choice_form').submit();
        });
    });
