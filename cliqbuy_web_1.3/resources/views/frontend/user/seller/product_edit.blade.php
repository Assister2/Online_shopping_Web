...
<div class="cls_bread">
    <ul>
        ...
        <li><a>{{ translate('Update your product')}}</a></li>
    </ul>
</div>
...
<form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <input type="hidden"  value="{{$enable_add_product}}" id="enable_add_product">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label"
                            for="signinSrEmail">{{translate('Gallery Images')}}<span class="text-danger">*</span></label>
                        <div class="col-md-8">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-6"> 
                   <input type="text" placeholder="{{translate('Unit price')}}" min="1" name="unit_price" class="form-control"
...
<!--            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input type="number" lang="en" step="0.01" placeholder="{{translate('Discount')}}"
            ...
            <div id="show-hide-div">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="number" lang="en" value="{{ $product->stocks->first()->qty }}" min="1" value="1" step="1"
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body collapse show" id="collapse_2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input type="radio" name="shipping_type" class="parent_provider" value="free" @if($product->shipping_type == 'free')
                            checked @endif>
                            <span></span>
                        </label>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input type="radio" name="shipping_type" class="parent_provider" value="flat_rate" @if($product->shipping_type ==
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="low_stock_quantity" value="{{ $product->low_stock_quantity }}" min="1" value="1" 
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @else
                <p>
                    {{ translate('cash_on_delivery_by_admin') }}
                </p>
                @endif
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="mar-all text-right">
            <button type="{{$enable_add_product=='true'?'submit':'button'}}" name="product_s" value="publish"
                class="btn btn-primary {{$enable_add_product=='true'?'':'disabled'}} form-button" id="product_submit">{{ translate('Update Product') }}</button>
        </div>
    </div>
    </div>
</form>
<div class="modal fade" id="warningProduct">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h6">{{translate('! Warning')}}</h5>
                <button type="button" class="close" data-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p>{{translate('Kindly upgrade')}}</p>
            </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
        if($('#enable_add_product').val()!='true'){
            $('#warningProduct').modal('show');
        }
    });
    function update_sku(){
        $.ajax({
