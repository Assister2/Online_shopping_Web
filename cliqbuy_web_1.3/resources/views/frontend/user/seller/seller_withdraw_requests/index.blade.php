...
@section('panel_content')
    ...
    <ul>
        ...
        <li><a>{{ translate('Money Withdraw') }}</a></li>
    </ul>
</div>
    ...
    <div class="row gutters-10">
        <div class="col-md-4 mb-3 ml-auto" >
            <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
              <span class="size-30px rounded-circle mx-auto bg-soft-primary d-flex align-items-center justify-content-center mt-3 currency_bg">
                  <!-- <i class="las la-dollar-sign la-2x text-white"></i> -->
                  <big>{{ currency_symbol() }}</big>
              </span>
                    ...
                    <form class="" action="{{ route('withdraw_requests.store') }}" method="post">
                        ...
                        <div class="modal-body gry-bg px-3 pt-3">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" lang="en" class="form-control mb-3" name="amount" min="1" max="{{ convert_price(Auth::user()->seller->admin_to_pay) }}" placeholder="{{ translate('Amount') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
