            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm fs-16" href="{{route('customer_products.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
							   <i class="las la-edit"></i>
						    </a>
                            {{-- <a href="{{route('customer_products.edit',encrypt($product->id))}}" class="btn btn-soft-info btn-icon btn-circle btn-sm fs-16" title="{{ translate('Edit') }}">
                              <i class="las la-edit"></i>
                            </a> --}}
                            <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete fs-16" data-href="{{route('customer_products.destroy', $product->id)}}" title="{{ translate('Delete') }}">
