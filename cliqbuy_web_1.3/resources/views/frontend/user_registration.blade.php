                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{  translate('Password') }}" name="password" autocomplete="on">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="{{  translate('Confirm Password') }}" name="password_confirmation" autocomplete="on">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="aiz-checkbox">
                                                ...
                                                <a href="{{ url('/privacypolicy') }}" style="text-decoration: underline;">{{ translate('Privacy Policy') }} 
                                                </a>
                                                
                                                <a href="{{ url('/terms') }}" style="text-decoration: underline;">
