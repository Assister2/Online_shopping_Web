                ...
                <div class="row">
                                    ...
                                    <div class="p-3">
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @endif
                                                <li class="mb-2">
                                                    <a class="aiz-side-nav-link fs-14 fw-600 {{ areActiveRoutes(['products.category', \App\Category::find($category_id)->slug])}}" href="{{ route('products.category', \App\Category::find($category_id)->slug) }}">
                                                        @if(\App\Utility\CategoryUtility::get_immediate_children_ids($category_id))
                                                        <i class="las la-angle-left"></i>
                                                        @else
                                                            &nbsp&nbsp&nbsp
                                                        @endif
                    ...
                    <div class="col-xl-9">
                        ...
                        <ul class="breadcrumb bg-transparent p-0">
                            ...
                            @endif
                            @if(isset($current_category) && $current_category->parentCategory!=null)
                                <li class="breadcrumb-item opacity-50">
                                    <a class="text-reset" href="{{ route('products.category', $current_category->parentCategory->slug) }}">{{ $current_category->parentCategory->getTranslation('name') }}</a>
                                </li>
                            @endif
                            @if(isset($category_id))
                        ...
                        <div class="text-left">
                            <div class="d-flex align-items-center">
                                <div>
                                    <h1 class="h6 fw-600 text-body mb-0">
                                        @if(isset($category_id))
                                            {{ \App\Category::find($category_id)->getTranslation('name') }}
                                        @elseif(isset($query))
                                ...
                                <div class="form-group w-200px ml-3 fliter-field">
                        ...
                        <div class="row gutters-5 product-list row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            @if($products->count() > 0)
                                ...
                                @endforeach
                            @else    
                                <span class="fw-300 text-center no-product" style="font-size: 30px;margin-left: 300px;">
                                    {{ translate('No products are available now')}}
                                </span> 
                            @endif
                        </div>
