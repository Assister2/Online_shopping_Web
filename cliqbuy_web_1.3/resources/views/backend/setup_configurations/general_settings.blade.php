            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Email Logo')}}</label>
                            <div class="col-sm-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                                    ...
                                    <input type="hidden" name="email_logo" value="{{ get_setting('email_logo') }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm"></div>
                                <small>{{ translate('Will be used in sending email') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">Maximum Owe Amount</label>
                            <div class="col-sm-9">
                                <input type="number" min="1" name="max_owe_amount" class="form-control" value="{{ get_setting('max_owe_amount') }}">
                                <span class="text-danger">{{ $errors->first('max_owe_amount') }}</span>
                            </div>
                        </div>                        
