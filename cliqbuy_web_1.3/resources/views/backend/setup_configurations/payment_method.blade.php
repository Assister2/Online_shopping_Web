                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="paypal_client_id" value="{{  get_setting('paypal_client_id') }}" placeholder="{{ translate('Paypal Client ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="paypal_client_secret" value="{{  get_setting('paypal_client_secret') }}" placeholder="{{ translate('Paypal Client Secret') }}" required>
                            </div>
                        </div><div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paypal Webhook Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="paypal_webhook_key" value="{{  get_setting('paypal_webhook_key') }}" placeholder="{{ translate('Paypal Webhook Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="stripe_key" value="{{  get_setting('stripe_key') }}" placeholder="{{ translate('Stripe Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="stripe_secret" value="{{  get_setting('stripe_secret') }}" placeholder="{{ translate('Stripe Secret') }}" required>
                            </div>
                        </div> 
                     <!--    <div class="form-group row">
                            <input type="hidden" name="types[]" value="STRIPE_WEBHOOK_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Stripe Webhook Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="STRIPE_WEBHOOK_KEY" value="{{  env('STRIPE_WEBHOOK_KEY') }}" placeholder="{{ translate('Stripe Webhook Key') }}" required>
                            </div>
                        </div> -->
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Stripe Webhook Secret Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="stripe_webhook_secret_key" value="{{  get_setting('stripe_webhook_secret_key') }}" placeholder="{{ translate('Stripe Webhook Secret Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
