        ...
        <div class="card-header row gutters-5">
            <div class="text-center text-md-left">
               ...
               <div class="mt-2">
                   <span> 
                        @if($ticket->user != null)
                            {{ ($ticket->user->deleted_at == '') ? $ticket->user->name : 'Deleted User' }}
                        @endif
                     </span>
            ...
            <div class="pad-top">
                <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0">
                            <div class="media">
                                <a class="media-left" href="#">
                                    @if($ticketreply->user->deleted_at=='' && $ticketreply->user->avatar_original != null)
                                ...
                                <div class="media-body">
                                    <div class="">
                                        <span class="text-bold h6">
                                            @if($ticketreply->user != null)
                                                {{ ($ticketreply->user->deleted_at == '') ? $ticketreply->user->name : 'Deleted User' }}
                                            @endif
                                        </span>
                    ...
                    <li class="list-group-item px-0">
                        <div class="media">
                            <a class="media-left" href="#">
                                @if($ticket->user->deleted_at=='' && $ticket->user->avatar_original != null)
