...
<div class="form-group row">
   ...
   <div class="col-lg-7">
      <input type="number" lang="en" min="0" step="0.01" max="10000" placeholder="{{translate('Discount')}}" name="discount" class="form-control" required>
   </div>
   <div class="col-lg-2">
...
<div class="form-group row">
   ...
   <div class="col-lg-9">
      <input type="number" lang="en" min="0" step="0.01" max="10000" placeholder="{{translate('Maximum Discount Amount')}}" name="max_discount" class="form-control" required>
   </div>
</div>
<div class="form-group row">
