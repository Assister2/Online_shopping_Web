<form class="form-horizontal" action="{{ route('commissions.pay_to_seller') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-header">
    	<h5 class="modal-title h6">{{ translate('pay_to_seller') }}</h5>
        ...
        @if ($seller->admin_to_pay > 0)
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    @else
                        <input type="number" lang="en" min="0" step="0.01" name="amount" id="amount" value="{{ $requested_amount }}" class="form-control" required>
                    @endif
                </div>
            </div>
