            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Merchant Orders') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Users') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Promote') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Settings') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Admin Users') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        @if(get_setting('subscription')=='1' && !isSingleStoreActivated())
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Merchant Subscriptions') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
