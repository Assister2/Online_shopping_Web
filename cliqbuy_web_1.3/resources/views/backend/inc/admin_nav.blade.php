            ...
            <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                         <a class="btn btn-icon btn-circle btn-light cls_circle" href="{{ route('home')}}" target="_blank" title="{{ translate('Browse Website') }}">
                            <i class="las la-globe"></i> <span>Visit {{ get_setting('site_name') }}</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="aiz-topbar-item">
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    <a class="dropdown-toggle no-arrow cls_langimg" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon">
                            <img src="{{ static_asset('assets/img/flags/'.$locale.'.png') }}" class="">
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs lang-change">
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown cls_profile_drop">
