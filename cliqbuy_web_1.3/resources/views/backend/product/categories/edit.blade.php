            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Name')}}<em class="text-danger">*</em>&nbsp;<i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                           <input type="number" name="order_level" value="{{ $category->order_level }}" min="0" class="form-control" id="order_level" placeholder="{{translate('Order Level')}}" oninvalid="this.setCustomValidity('Ordering Number must be a positive number')" oninput="this.setCustomValidity('')">
