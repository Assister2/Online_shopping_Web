            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Name')}}<em class="text-danger">*</em></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                             <input type="number" name="order_level" min="0" class="form-control" id="order_level" placeholder="{{translate('Order Level')}}" oninvalid="this.setCustomValidity('Ordering Number must be a positive number')" oninput="this.setCustomValidity('')">
