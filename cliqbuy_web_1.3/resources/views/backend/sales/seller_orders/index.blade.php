    ...
    <form class="" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
                <h5 class="mb-md-0 h6">{{ translate('Merchant Orders') }}</h5>
            </div>
            <div class="col-lg-2">
            ...
            <tbody>
                @foreach ($orders as $key => $order_id)
                    @php
                        ...
                        $order_detials = \DB::table('order_details')->where('order_id',$order_id->id)->where('seller_id', '!=', $admin_user_id);
                        $order_detail =$order_detials->first();
                        $order_details = $order_detials->get();
                        $seller = \DB::table('shops')->where('user_id',$order_detail->seller_id)->first();
                    @endphp
                    @if($order != null)
                        <tr>
                            <td>
