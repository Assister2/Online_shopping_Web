...
<div class="row">
	<div class="col-xl-10 mx-auto">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind. Home slider size 1500 x 600.') }}
				</div>
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}<span class="text-danger">*</span></label>
								...
								@foreach (json_decode(get_setting('home_slider_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_slider_links">
												<input type="text" class="form-control" placeholder="http://" name="home_slider_links[]" required value="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
											</div>
										</div>
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_slider_links">
										<input type="text" required class="form-control" placeholder="http://" name="home_slider_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 1') }}<span class="fw-300 opacity-50">{{translate(' (Max 4 Looks Better)')}}</span></h6>
				<p class="opacity-50">{{ translate('For first banner size 342 x 420 and remain size 347 x 206') }}</p>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<label>{{ translate('Banner & Links') }}<span class="text-danger">*</span></label>
								...
								@foreach (json_decode(get_setting('home_banner1_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner1_links">
												<input type="text" required class="form-control" placeholder="http://" name="home_banner1_links[]" value="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner1_links">
										<input type="text" required class="form-control" placeholder="http://" name="home_banner1_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 2') }}<span class="fw-300 opacity-50">{{translate(' (Max 4 Looks Better)')}}</span></h6>
				<p class="opacity-50">{{ translate('size 347 x 206') }}</p>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
								...
								@foreach (json_decode(get_setting('home_banner2_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner2_links">
												<input type="text" class="form-control" required placeholder="http://" name="home_banner2_links[]" value="{{ json_decode(get_setting('home_banner2_links'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner2_links">
										<input type="text" required class="form-control" placeholder="http://" name="home_banner2_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 3') }}<span class="fw-300 opacity-50">{{translate(' (Max 4 Looks Better)')}}</span></h6>
				<p class="opacity-50">{{ translate('size 347 x 206') }}</p>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
								...
								@foreach (json_decode(get_setting('home_banner3_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_links">
												<input type="text" required class="form-control" placeholder="http://" name="home_banner3_links[]" value="{{ json_decode(get_setting('home_banner3_links'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner3_links">
										<input type="text" class="form-control" required placeholder="http://" name="home_banner3_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
					@php
						$categories = \App\Category::where('parent_id', 0)->where('digital', 0)->with('childrenCategories')->get();
						...
						$selected_top10_brands 		= get_setting('top10_brands');
						$selected_top10_brands      = ($selected_top10_brands) ? json_decode(get_setting('top10_brands'), true) : [];

						//dd($selected_top10_categories, $selected_top10_brands);
					@endphp
				</div>
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group row">
						...
						<div class="col-md-10 bootstrap-select">
							<input type="hidden" name="types[]" value="top10_categories">
							<select name="top10_categories[]" class="form-control aiz-selectpicker" multiple data-max-options="10" data-live-search="true" data-selected-text-format="count">
								@foreach ($categories as $category)
                                <option value="{{ $category->id }}" <?php if(in_array($category->id, $selected_top10_categories)) { echo 'selected="selected"'; } ?>>{{ $category->getTranslation('name') }}</option>
                                @foreach ($category->childrenCategories as $childCategory)
                                @include('categories.child_category', ['child_category' => $childCategory])
                                @endforeach
                                @endforeach
					...
					<div class="form-group row">
						...
						<div class="col-md-10 bootstrap-select">
							...
							<select name="top10_brands[]" class="form-control aiz-selectpicker" multiple data-max-options="10" data-live-search="true" data-selected-text-format="count">
								@foreach (\App\Brand::all() as $key => $brand)
									<option value="{{ $brand->id }}" <?php if(in_array($brand->id, $selected_top10_brands)) echo 'selected="selected"'; ?>>{{ $brand->getTranslation('name') }}</option>
								@endforeach
							</select>
						</div>
					</div>
