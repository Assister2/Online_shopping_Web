                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ uploaded_asset( get_setting('email_logo') ) }}" width="191" height="40" style="object-fit: contain" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:45px; text-align:left; padding-bottom:10px;">{{ translate("Hi") }} <b>{{ ucfirst($user->name) }}</b>
                                                        <p style="margin-top:0;margin-bottom:15px;">{{trans("messages.front_end.please_use_otp") }} {!! ( sprintf("<b>%s</b>", $user->otp) ) !!} {{trans("messages.front_end.below_delete_account")}}</p>
                                                        <p style="margin-top:0;margin-bottom:15px;">{{ translate("Thank You") }}.</p></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
