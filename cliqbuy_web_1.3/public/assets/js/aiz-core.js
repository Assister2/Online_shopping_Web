  ...
  AIZ.uploader = {
    ...
    getAllUploads: function (url, search_key = null, sort_key = null) {
      ...
      $.get(url, params, function (data, status) {
        $(".aiz-uploader-all").removeClass('loading')
        //console.log(data);
    ...
    updateUploaderFiles: function () {
      ...
      setTimeout(function () {
        ...
        if (data.length > 0) {
          ...
          $(".aiz-uploader-all").html(
            '<div class="align-items-center d-flex h-100 justify-content-center w-100 nav-tabs"><div class="text-center"><h3>' + no_files_found + '</h3></div></div>'
          );
        }
        ...
        uppy.use(Uppy.Dashboard, {
          ...
          locale: {
            strings: {
              ...
              retry:  AIZ.local.retry,
              xTimeLeft: "%{time} " + AIZ.local.left,
              filesUploadedOfTotal:{0:"%{complete} "+ AIZ.local.of +" %{smart_count} " + AIZ.local.fileuploaded,1:"%{complete} " + AIZ.local.of + "%{smart_count} " + AIZ.local.filesuploaded,2:"%{complete} "+ AIZ.local.of +" %{smart_count} " + AIZ.local.filesuploaded},
              xFilesSelected: {
