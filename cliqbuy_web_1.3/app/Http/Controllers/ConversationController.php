...
class ConversationController extends Controller
{
    ...
    public function index()
    {
        if (BusinessSetting::where('type', 'conversation_system')->first()->value == 1) {
            ...
            flash(translate('convo_is_disabled'))->warning();
            return back();
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        if($conversation->save()) {
            ...
            $message->product_link = $request->product_link;
        ...
        flash(translate('message_has_been_send_to_seller'))->success();
        return back();
    }
    ...
    public function send_message_to_seller($conversation, $message, $user_type)
    {
        ...
        $array['content'] = translate("received_msg_from").' '.Auth::user()->name.'.';
        ...
        $array['product_link'] = $message->product_link;
        $array['product_name'] = $conversation->title;
    ...
    public function destroy($id)
    {
        ...
        if(Conversation::destroy(decrypt($id))){
            flash(translate('convo_deleted'))->success();
            return back();
        }
    }
}
