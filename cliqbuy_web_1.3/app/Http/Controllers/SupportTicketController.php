...
class SupportTicketController extends Controller
{
    ...
    {
        $ticket = new Ticket;
        $ticket->code = rand(10000000, 99999999);
        // max(100000, (Ticket::latest()->first() != null ? Ticket::latest()->first()->code + 1 : 0)).date('s');
        ...
        if($ticket->save()){
            ...
            flash(translate('ticket_has_been_sent_successfully'))->success();
    ...
    public function send_support_mail_to_admin($ticket){        
        ...
        $array['subject'] = translate("support_ticket_code")." ".$ticket->code;
        $array['from'] = get_setting('mail_from_address');
        $array['content'] = translate('ticket_created');
    ...
    public function admin_store(Request $request)
    {
        ...
        if($ticket_reply->save()){
            flash(translate('reply_has_been_sent_successfully'))->success();
