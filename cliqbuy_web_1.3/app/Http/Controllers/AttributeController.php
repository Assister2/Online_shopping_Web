...
class AttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(translate('attr_inserted'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(translate('attr_updated'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(translate('attr_deleted'))->success();
        return redirect()->route('attributes.index');
    ...
    public function store_color(Request $request) {
        ...
        flash(translate('color_inserted'))->success();
    ...
    public function update_color(Request $request, $id)
    {
        ...
        flash(translate('color_updated'))->success();
        return back();
    }
    ...
    public function destroy_color($id)
    {
        ...
        flash(translate('color_deleted'))->success();
        return redirect()->route('colors');
