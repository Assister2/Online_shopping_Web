...
class ShippingController extends Controller
{
    public function shipping_cost(Request $request)
    {
        ...
        $total_shipping = Cart::where('user_id', $request->user_id)->get();
        $total_shipping_cost = 0;

        foreach ($total_shipping as $key => $items) {
            $total_shipping_cost += getShippingCost($total_shipping, $key);
        }
        ...
        return response()->json(['result' => true, 'shipping_type' => get_setting('shipping_type'), 'value' => $total_shipping_cost ,'value_string'=>format_price($total_shipping_cost)], 200);
    }
